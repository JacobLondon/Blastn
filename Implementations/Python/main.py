...
Test the different modules together for determining
performance of current techniques we are using for BlastN.

This is unfinished, and does not currently perform BlastN
properly.
"""
...
def blastn():
    ...
    # extend then score with smith-waterman
